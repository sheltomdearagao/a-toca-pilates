...
const FinancialOverviewCards = ({ stats, isLoading, formatCurrency }: FinancialOverviewCardsProps) => {
  return (
    <div className="grid gap-4 md:grid-cols-3 mb-6">
      <Card className={cn("shadow-impressionist border-l-4", stats?.monthlyRevenue ? "border-primary" : "border-muted")}> {/* Aplicando a nova sombra e borda colorida */}
      ...
      <Card className={cn("shadow-impressionist border-l-4", stats?.monthlyExpense ? "border-destructive" : "border-muted")}> {/* Aplicando a nova sombra e borda colorida */}
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card className={cn("shadow-impressionist border-l-4", stats?.totalOverdue ? "border-payment-overdue" : "border-muted")}> {/* Aplicando a nova sombra e borda colorida */}
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
